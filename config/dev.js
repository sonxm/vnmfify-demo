...
module.exports = {
  ...
  mini: {
        ...
        optimization: {
            ...
            cacheGroups: {
              ...
              taroify: {
                ...
                test(module) {
                  ...
                  return /node_modules[\\/]@vnmfify/.test(module.resource)
                },
                //
                // test: /node_modules[\\/]@vnmfify/,
                // just higher than 10 will be fine, refer to
                // https://github.com/NervJS/vnmf/blob/bc6af68bda2cbc9163fbda36c15878fc96aec8f1/packages/vnmf-mini-runner/src/webpack/build.conf.ts#L220-L254
                priority: 100,
              },
            },
          },
          ...
          minimizer: [
            new TerserPlugin({
              ...
              test: ["common.js", "vnmf.js", "vendors.js", "lodash.js", "taroify.js"],
              parallel: true,
    ...
    // refer to http://vnmf-docs.jd.com/vnmf/docs/config-detail/#minisourcemaptype
